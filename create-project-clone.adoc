---
sidebar: sidebar
permalink: create-project-clone.html
keywords: create, clone, project
summary: Create a project clone in workload factory for Builders.
---
= Create a project clone in workload factory for Builders
:icons: font
:imagesdir: ./media/

[.lead]
Creating a clone of a project in workload factory for Builders enables you to use the clone for development, testing, integration, analytics, training, QA, and more without altering the original project. 
